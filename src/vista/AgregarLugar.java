 ...
 * @author rober
 */
public class AgregarLugar extends javax.swing.JFrame {
    ...
    private void agregarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarBtnActionPerformed
        ...
        if(!this.descripcionTxt.getText().isBlank()){
            Lugar e=new Lugar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarLugar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
